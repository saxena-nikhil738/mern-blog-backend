...
const CreatePost = () => {
  ...
  return (
    <>
      <Card className="mx-auto" style={{ height: 750, width: 1000 }}>
        {/* <CardActionArea > */}
        <CardMedia
        ...
        {error && <Error>{error}</Error>}
          <StyledFormControl className="mt-4">
            ...
            />
            <InputTextField className="bg-light p-1 "
              required
          ...
          <TextArea className="desc bg-light p-1"
            required
            rowsMin={5}
            minRows={2}
            maxRows={2}
